...
namespace Celular.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description,Type,CategoriaID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description,Type,CategoriaID")] Item item)
        {
            if (id != item.ID)
            {
                return NotFound();
